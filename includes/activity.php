...
class BP_Idea_Stream_Activity {
	...
	public function setup_actions() {
		...
		add_action( 'bp_idea_stream_group_changed',     array( $this, 'change_item_id' ),         10, 4 );
		add_action( 'bp_idea_stream_remove_from_group', array( $this, 'reset_activity_item_id' ), 10, 3 );
	...
	public function register_activity_actions() {
		 ...
		 */
		$this->activity_actions = apply_filters( 'bp_idea_stream_get_activity_actions', array(
	...
	public function dropdown_filters( $tracking_args ) {
		 ...
		 */
		return apply_filters( 'bp_idea_stream_activity_filters', $tracking_args );
	}
	...
	public function adjust_activity_args( $activity = null ) {
		 ...
		 */
		$activity = apply_filters( 'bp_idea_stream_pre_adjust_activity', $activity, $this->idea );
		 ...
		 * @param BP_Activity_Activity $activity   the activity object
		 */
		$activity = apply_filters( 'bp_idea_stream_adjust_activity', $activity );
	...
	public function mark_activity_private( $idea_id = 0, $idea = null ) {
		...
		// Otherwise, we need to create the activity
			 ...
			 * @param WP_Post $idea    the idea object
			 */
			$args = apply_filters( 'bp_idea_stream_activity_post_private', $args, $idea );
	...
	public function maybe_delete_activity( $idea_id = 0, $idea = null ) {
		...
		// Make sure these activities are public
			 ...
			 * @param WP_Post $idea      the idea object
			 */
			$edit_args = apply_filters( 'bp_idea_stream_activity_edit', array(), $idea );
