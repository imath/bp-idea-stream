...
function bp_idea_stream_format_notifications( $action = '', $item_id = 0, $secondary_item_id = 0, $total_items = 0, $format = 'string' ) {
	 ...
	 * @param  int $total_items       the number of objects concerned
	 */
	do_action( 'bp_idea_stream_format_notifications', $action, $item_id, $secondary_item_id, $total_items );
...
add_action( 'wp_idea_stream_comments_notify_author', 'bp_idea_stream_comments_notify_idea_author', 10, 1 );
add_action( 'comment_unapproved_to_approved',        'bp_idea_stream_comments_notify_idea_author', 10, 1 );
...
add_action( 'trash_comment',  'bp_idea_stream_comments_delete_notifications_by_comment_id',  10, 1 );
add_action( 'spam_comment',   'bp_idea_stream_comments_delete_notifications_by_comment_id',  10, 1 );
add_action( 'delete_comment', 'bp_idea_stream_comments_delete_notifications_by_comment_id',  10, 1 );
...
add_action( 'wp_idea_stream_added_rate', 'bp_idea_stream_rates_notify_idea_author', 10, 2 );
...
add_action( 'wp_idea_stream_deleted_rate', 'bp_idea_stream_rates_delete_notification', 10, 2 );
...
add_action( 'wp_trash_post', 'bp_idea_stream_delete_notifications_by_post_id', 10, 1 );
...
add_action( 'deleted_user', 'bp_idea_stream_delete_all_user_notifications', 11, 1 );
...
add_action( 'wp_idea_stream_delete_user_rates', 'bp_idea_stream_delete_notifications_by_user', 10, 1 );
...
add_action( 'bp_screens', 'bp_idea_stream_comments_mark_notifications_read', 11 );
