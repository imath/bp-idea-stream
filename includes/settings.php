 ...
 * @uses   apply_filters() call 'bp_idea_stream_settings_field' to add/remove setting fields
...
function bp_idea_stream_settings_field( $setting_fields = array() ) {
	$setting_fields['ideastream_settings_buddypress']['_ideastream_buddypress_integration'] = array(
		...
		'callback'          => 'bp_idea_stream_setting_callback',
 ...
 */
function bp_idea_stream_setting_callback() {
