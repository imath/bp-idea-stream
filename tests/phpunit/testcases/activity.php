 ...
 * @group activity
 */
class BP_Idea_Stream_Activity_Tests extends BP_Idea_Stream_TestCase {
	 ...
	 */
	public function test_bp_idea_stream_activity_publish() {
	 ...
	 * @group admin_created
	 */
	public function test_bp_idea_stream_activity_private() {
	 ...
	 * @group admin_created
	 */
	public function test_bp_idea_stream_activity_password() {
	 ...
	 */
	public function test_bp_idea_stream_activity_public_group() {
		$bp = buddypress();
	 ...
	 * @group group_activity
	 */
	public function test_bp_idea_stream_activity_private_group() {
		$bp = buddypress();
		$reset_current_group = $bp->groups->current_group;
		$reset_current_component = $bp->current_component;
		$bp->current_component = $bp->groups->id;
	 ...
	 */
	public function test_bp_idea_stream_idea_activity_actions() {
	 ...
	 * @group show_hidden
	 */
	public function test_bp_idea_stream_idea_switch_status_activity_visibility() {
		$u = $this->factory->user->create();
